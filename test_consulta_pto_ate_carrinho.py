...
class TestConsultaPtoAteCarrinho():
  ...
  def test_consulta_pto_ate_carrinho(self):
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, "li > span:nth-child(2)").text == "Buquê 10 Girassóis"
    assert self.driver.find_element(By.CSS_SELECTOR, ".preco_prod > .precoPor_prod").text == "R$ 289,90"
    ...
    assert self.driver.find_element(By.LINK_TEXT, "Buquê 10 Girassóis").text == "Buquê 10 Girassóis"
    assert self.driver.find_element(By.CSS_SELECTOR, ".precoPor_basket:nth-child(2)").text == "R$ 289,90"
